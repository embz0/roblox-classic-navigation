...
![Roblox Classic Navigation sidebar preview](assets/screenshots/classic-sidebar.png)
...
The classic sidebar keeps the account header, navigation badges, Roblox Plus entry, active promotion, and extension-provided event content in a compact legacy-style layout.
